...
import snill.client.mixin.WorldRendererAccessor;
...
public class ShaderEsp extends Module {
    ...
    private Framebuffer getOutlineSourceFramebuffer() {
        if (mc.worldRenderer instanceof WorldRendererAccessor accessor) {
            Framebuffer raw = accessor.snill$getEntityOutlineFramebufferRaw();
    ...
    public boolean shouldOutline(Entity entity) {
        ...
        if (entity instanceof LivingEntity living && AntiBot.checkBot(living)) return false;
