package snill.client.api.utils.input;
...
public class KeyBoardUtils implements QClient {
    ...
    public void call(int key, int action) {
        ...
        if (action == 1) {
            ...
            if (ModuleClass.INSTANCE.searchHelper.isEnable()
                    && key == ModuleClass.INSTANCE.searchHelper.bind.getKey()) {
                ModuleClass.INSTANCE.searchHelper.onBindPressed();
            }
    ...
    public void callMouse(int button, int action) {
        ...
        if (action == 1) {
            ...
            if (ModuleClass.INSTANCE.searchHelper.isEnable()
                    && mouseKey == ModuleClass.INSTANCE.searchHelper.bind.getKey()) {
                ModuleClass.INSTANCE.searchHelper.onBindPressed();
            }
