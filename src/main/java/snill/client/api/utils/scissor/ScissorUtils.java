package snill.client.api.utils.scissor;
...
public class ScissorUtils {
    ...
    private static double customScale = 1.0D;

    public static void setCustomScale(double scale) {
        customScale = Math.max(0.01D, scale);
    }
    ...
    public static void setFromComponentCoordinates(double x, double y, double width, double height) {
        ...
        double scaleFactor = getScaleFactor() * customScale;
