package snill.client.api.events;
...
public class EventInvoker
{
    ...
    private static final long SLOW_HANDLER_NANOS = Long.getLong("polar.perf.handlerMs", 8L) * 1_000_000L;
    private static final long SLOW_EVENT_NANOS = Long.getLong("polar.perf.eventMs", 18L) * 1_000_000L;
    private static final long WARN_COOLDOWN_NANOS = Long.getLong("polar.perf.cooldownMs", 1000L) * 1_000_000L;
    ...
    public static void invoke(Event event) throws IllegalAccessException, InvocationTargetException, InstantiationException
    {
        ...
        List<Invocation> invocations = resolveInvocations(event.getClass());
    ...
    public static boolean hasListeners(Class<? extends Event> eventClass)
    {
        ...
        List<Invocation> invocations = resolveInvocations(eventClass);
    ...
    private static List<Invocation> resolveInvocations(Class<? extends Event> eventClass)
    {
        ...
        ArrayList<Invocation> resolved = new ArrayList<>();
        for (var entry : invocationCache.entrySet())
        {
